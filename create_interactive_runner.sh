...
my_file="// This file is an interactive runner for $1.txt.\n"
...
my_file+="    var p = new jslisp.IntString('prompt');\n"
my_file+="    var main_f = global_scope.get(m);\n"
my_file+="    var get_prompt = global_scope.get(p);\n"
my_file+="    var show_prompt = function () {\n"
my_file+="        try {\n"
my_file+="            var p_val = get_prompt.call(new jslisp.List([]));\n"
my_file+="            if (!(p_val instanceof jslisp.IntString)) {\n"
my_file+="                throw '(prompt) must be a string.'\n"
my_file+="            }\n"
my_file+="            process.stdin.write(p_val.s);\n"
my_file+="        } catch (e) {\n"
...
echo $my_file > "$1_interactive_runner.js"